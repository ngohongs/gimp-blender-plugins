...
static void query (void)
{
  ...
  gimp_install_procedure (
    "plug-in-inverse-1-fastest-fix",
    "Inverse nejrychlejsi s opravou (bez nahledu)",
    "Invertuje obrazek",
    "Jiri Chludil",
    "Copyright Jiri Chludil",
    "2016",
    "_Inverse 1 s nejrychlejsi opravou (bez nahledu)...",
    "RGB*, GRAY*",
    GIMP_PLUGIN,
    G_N_ELEMENTS (args), 0,
    args, NULL);

   gimp_plugin_menu_register ("plug-in-inverse-1-fastest-fix","<Image>/Filters/Misc");
}
